...
if f.uniform:has_field("pt16_maximum_error") then
  ...
  --f.uniform:get_field("strain_rate_viscosity"):set(0.9) -- looks strange
  f.uniform:get_field("strain_rate_viscosity"):set(0.99) -- looks ok (buckling)
  --f.uniform:get_field("strain_rate_viscosity"):set(0.999) -- looks pretty similar (buckling)
  --]]

  --[[ looks nice, fairl flat, not 'dissolving'
  ...
  cfg.pt16.velocity_reconstruction_maximum_error = .1
  cfg.pt16.velocity_reconstruction_maximum_iterations = 500
  f.uniform:get_field("strain_rate_viscosity"):set(0.9)
  --]]
end

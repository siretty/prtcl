...
class extract_requirements_xform : xform_helper {
public:
...
public:
  extract_requirements_xform(field_requirements &reqs_) : _reqs{reqs_} {}
...
static void extract_requirements(field_requirements &reqs_, Expr &&expr_) {
  boost::yap::transform(
